...
namespace lnapi
{
    ...
    {
        public async Task<ImageDetailsResponseModel> ImageDetailsAsync(int imageId)
        {
            return await RequestAsync<ImageDetailsResponseModel>("image", "details", new ImageDetailsRequestModel(_BRM, imageId));
        }
    }
}
